...
public:
    ...
    {
        threads_.push_back(std::thread(&AddTwoIntsClientNode::callAddTwoIntsService, this, 1, 4));
        threads_.push_back(std::thread(&AddTwoIntsClientNode::callAddTwoIntsService, this, 4, 5));
    }
